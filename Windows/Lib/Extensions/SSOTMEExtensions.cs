...
namespace SSoTme.OST.Lib.Extensions
{
    public static class SSOTMEExtensions
    {
        ...
        public static void CleanZippedFileSet(this byte[] zippedFileSet, bool debug, bool deleteEmptyDirs = true)
        {
        ...
        public static void CleanFileSet(this string fileSetXml, bool debug = false, bool deleteEmptyDirs = true)
        {
